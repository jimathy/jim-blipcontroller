if Config.DiscoveryBlips.enable then
    ...
    local fadeAlpha = 0
    local fadeState = "in"
    local discoveredStr = gameName == "rdr3" and CreateVarString(10, "LITERAL_STRING", locale("discoveredBlips", "discovered")) or locale("discoveredBlips", "discovered")
